...
const Footer = () => {
  ...
  return (
    <footer
      ...
      className="mt-auto flex h-80 w-full select-none flex-col items-center bg-black px-5 pt-5 text-white md:h-60 md:select-all md:pt-0"
    >
      <div className="flex w-full justify-between gap-4 md:mt-6 lg:w-7/12">
        ...
        <div
          ...
          className="flex h-full flex-col items-center justify-center gap-4 text-lg sm:gap-6 sm:text-xl md:flex-row md:gap-10 md:text-2xl"
        >
          <SocialIcons />
        </div>
      </div>
      <div
        aria-label={`All Rights Reserved ${year}`}
        className="mb-20 mt-auto flex w-full items-center justify-center text-xs text-gray-400 sm:text-sm md:mb-10"
      >
